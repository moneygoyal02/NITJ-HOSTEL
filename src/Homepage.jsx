    ...
    return (
        <div>
            ...
            <footer className="site-footer">
                Developed by <a href="https://www.linkedin.com/in/money-goyal/" target="_blank" rel="noopener noreferrer">Mone Goyal</a>
                <span className="copyright">© 2024 NITJ Hostel Portal. All rights reserved.</span>
            </footer>
        </div>
    );
};
